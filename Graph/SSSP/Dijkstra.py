...
class Node:
    ...
    # lt is for less than, to compare objects based on minimum distance
    def __lt__(self, other_node):
        return self.min_distance < other_node.min_distance


    def add_edge(self, weight, destinaion_vertex):
        edge = Edge(weight, self, destinaion_vertex)
        ...
        while self.heap:
            ...
            for edge in actual_vertex.neighbours:
                ...
                if new_distance < target.min_distance:
                    ...
                    heapq.heappush(self.heap, target)                            # Updating the heap
